  ...
  return (
    <div className="min-h-screen bg-black p-4 sm:p-6 md:p-8">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-[#1c1c1e] rounded-2xl shadow-lg border border-[#2c2c2e]">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-medium text-[#86868b]">Selected Departments</label>
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-medium text-[#86868b]">Selected Types</label>
                  <div className="flex flex-wrap gap-2">
